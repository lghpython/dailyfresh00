...
class IndexGoodsTypeBanner(BaseModel):
    ...
    display_type = models.SmallIntegerField(default=1,choices=DISPLAY_TYPES_CHOICES, verbose_name='展示类型')
    index = models.SmallIntegerField(default=0, verbose_name='展示顺序')
...
class IndexPromotionBanner(BaseModel):
    ...
    image = models.ImageField(upload_to='goods', verbose_name='活动图片')
    index = models.SmallIntegerField(default=0,verbose_name='展示顺序')
